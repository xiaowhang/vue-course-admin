<template>
  <el-dialog v-model="dialogFormVisible" :title="msgText + '资源'" width="500">
    <el-form :model="form" ref="formRef">
      ...
      <el-form-item label="资源路径" :label-width="formLabelWidth" prop="name">
        <el-input v-model="form.url" autocomplete="off" />
      </el-form-item>
      <el-form-item label="资源类别" :label-width="formLabelWidth" prop="sort">
      ...
      <el-form-item label="描述" :label-width="formLabelWidth" prop="sort">
...
const { dialogFormVisible, msgText, handleCreate, handleEdit, form } = useResources()
